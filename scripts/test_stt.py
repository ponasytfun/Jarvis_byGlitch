...
def main() -> int:
    parser = argparse.ArgumentParser(description="Record speech and transcribe it locally.")
    parser.add_argument(
        "--device-index",
        type=int,
        default=None,
    ...
    logger = logging.getLogger("JarvisAssistant.TestSTT")
    ...
    try:
        result = voice_agent.test_stt(config)
